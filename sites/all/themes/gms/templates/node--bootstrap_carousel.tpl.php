...
<div id="carousel-bootstrap" class="carousel slide">
    ...
    <?php foreach ($carousel_items as $id => $carousel_slide) : ?>
      <div class="item<?php ($id == '0') ? print ' active' : print ''; ?>">
        <?php if(!empty($carousel_slide['carousel_image'])) : ?>
          ...
          <img src="<?php print $img_url ?>" class="img-responsive" alt="<?php print $carousel_slide['image_alt_text'];?>"/>
        <?php endif; ?>
  ...
  <?php if (in_array(1, $control_options)) : ?>
    ...
    <a class="carousel-control left" href="#carousel-bootstrap" data-slide="prev"><span class="glyphicon glyphicon-triangle-left"></span></a>
    <a class="carousel-control right" href="#carousel-bootstrap" data-slide="next"><span class="glyphicon glyphicon-triangle-right"></span></a>
  <?php endif; ?>
